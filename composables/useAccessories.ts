...
export const accessories: Accessory[] = [
  ...
  },
  {
    ...
    category: 'Charging',
    price: 22,
    image: 'https://images.unsplash.com/photo-1619459072761-496c0812331b?auto=format&fit=crop&w=800&q=80',
  ...
  // Apple — more lines
  {
    id: 16,
    uuid: 'acc-0016',
    name: 'Leather MagSafe Folio — iPhone 16 Pro Max',
    brand: 'Apple',
    deviceLineId: 'iphone-16',
    versionId: 'iphone-16-pro-max',
    category: 'Case',
    price: 79,
    image: 'https://images.unsplash.com/photo-1601972599720-36938d4ecd31?auto=format&fit=crop&w=800&q=80',
    blurb: 'Full-grain leather, sleep/wake cover, card slot.',
  },
  {
    id: 17,
    uuid: 'acc-0017',
    name: 'MagSafe PopGrip Base — iPhone 16 series',
    brand: 'Apple',
    deviceLineId: 'iphone-16',
    versionId: 'all-line',
    category: 'Grip',
    ...
    blurb: 'Swap tops; strong magnet ring aligned for 16 lineup.',
  },
  {
    id: 18,
    uuid: 'acc-0018',
    name: 'Anti-Glare Film — iPhone 14 series',
    brand: 'Apple',
    deviceLineId: 'iphone-14',
    versionId: 'all-line',
    category: 'Screen protector',
    price: 26,
    image: 'https://images.unsplash.com/photo-1556656793-08538906a9f8?auto=format&fit=crop&w=800&q=80',
    blurb: 'Matte finish; reduces fingerprints in bright light.',
  },
  {
    id: 19,
    uuid: 'acc-0019',
    name: 'Sport Band Silicone — iPhone 13 series',
    brand: 'Apple',
    deviceLineId: 'iphone-13',
    versionId: 'all-line',
    category: 'Case',
    price: 24,
    image: 'https://images.unsplash.com/photo-1601784551446-20c9e07cdbdb?auto=format&fit=crop&w=800&q=80',
    blurb: 'Ventilated ribs; raised camera bumper per model.',
  },
  {
    id: 20,
    uuid: 'acc-0020',
    name: '35W Dual USB-C Wall Charger',
    brand: 'Apple',
    deviceLineId: 'iphone-15',
    versionId: 'all-line',
    category: 'Charging',
    price: 45,
    image: 'https://images.unsplash.com/photo-1596877445530-ad74838754c6?auto=format&fit=crop&w=800&q=80',
    blurb: 'Charge iPhone + AirPods at once; foldable prongs.',
  },
  {
    id: 21,
    uuid: 'acc-0021',
    ...
    category: 'Audio',
    price: 18,
    image: 'https://images.unsplash.com/photo-1600375104627-c94c416deefa?auto=format&fit=crop&w=800&q=80',
    blurb: 'Lightning / USB-C case cutout; carabiner included.',
  },
  // Samsung — more
  {
    id: 22,
    uuid: 'acc-0022',
    name: 'Galaxy S23 Ultra Camera Ring Glass',
    brand: 'Samsung',
    deviceLineId: 'galaxy-s23',
    versionId: 's23-ultra',
    category: 'Camera',
    price: 16,
    image: 'https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?auto=format&fit=crop&w=800&q=80',
    blurb: '9H tempered rings; aligns with S23 Ultra lenses.',
  },
  {
    id: 23,
    uuid: 'acc-0023',
    name: 'Galaxy S23 FE Hybrid Case',
    brand: 'Samsung',
    deviceLineId: 'galaxy-s23',
    versionId: 's23',
    category: 'Case',
    price: 31,
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=800&q=80',
    blurb: 'Clear back + TPU bumper; wireless charging friendly.',
  },
  {
    id: 24,
    uuid: 'acc-0024',
    name: 'Galaxy Buds3 Pro Rugged Case',
    brand: 'Samsung',
    deviceLineId: 'galaxy-s24',
    versionId: 'all-line',
    category: 'Audio',
    price: 22,
    image: 'https://images.unsplash.com/photo-1484704849700-f032a568e944?auto=format&fit=crop&w=800&q=80',
    blurb: 'Shock shell; fits Buds3 / Buds3 Pro charging case.',
  },
  {
    id: 25,
    uuid: 'acc-0025',
    name: '25W Super Fast Travel Adapter',
    brand: 'Samsung',
    deviceLineId: 'galaxy-a',
    versionId: 'all-line',
    category: 'Charging',
    price: 27,
    image: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?auto=format&fit=crop&w=800&q=80',
    blurb: 'PPS for Galaxy A & S series; EU + US clip included.',
  },
  // Google — more
  {
    id: 26,
    uuid: 'acc-0026',
    name: 'Pixel 9 Pro XL Camera Bar Skin',
    brand: 'Google',
    deviceLineId: 'pixel-9',
    versionId: 'pixel-9-pro-xl',
    category: 'Skin',
    price: 14,
    image: 'https://images.unsplash.com/photo-1621839673705-6617adf9e890?auto=format&fit=crop&w=800&q=80',
    blurb: 'Precision vinyl; matte black or carbon look.',
  },
  {
    id: 27,
    uuid: 'acc-0027',
    name: 'Pixel 7 Pro Leather Case',
    brand: 'Google',
    deviceLineId: 'pixel-7',
    versionId: 'pixel-7-pro',
    category: 'Case',
    price: 44,
    image: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=800&q=80',
    blurb: 'Vegetable-tanned; metal buttons for power/volume.',
  },
  {
    id: 28,
    uuid: 'acc-0028',
    name: 'Pixel 8 Fabric Cable Organizer',
    brand: 'Google',
    deviceLineId: 'pixel-8',
    versionId: 'all-line',
    category: 'Accessory',
    price: 12,
    image: 'https://images.unsplash.com/photo-1562408590-e32931084e23?auto=format&fit=crop&w=800&q=80',
    blurb: 'Recycled fabric wrap; keeps USB-C tidy in bag.',
  },
  // Universal — more
  {
    id: 29,
    uuid: 'acc-0029',
    name: '15W Qi2 Magnetic Wireless Pad',
    brand: 'Universal',
    deviceLineId: 'all-phones',
    versionId: 'all',
    category: 'Charging',
    ...
    blurb: 'Qi2 certified; works with MagSafe & compatible Android.',
  },
  {
    id: 30,
    uuid: 'acc-0030',
    ...
    blurb: 'Six strong magnets; 360° ball joint; metal plate kit.',
  },
  {
    id: 31,
    uuid: 'acc-0031',
    name: '10,000mAh Slim Power Bank (USB-C)',
    brand: 'Universal',
    deviceLineId: 'all-phones',
    versionId: 'all',
    category: 'Charging',
    ...
    blurb: '20W PD out + pass-through; LED charge indicator.',
  },
  {
    id: 32,
    uuid: 'acc-0032',
    name: 'Phone + Lens Cleaning Kit',
    brand: 'Universal',
    deviceLineId: 'all-phones',
    versionId: 'all',
    category: 'Care',
    price: 15,
    image: 'https://images.unsplash.com/photo-1692645214212-ea7fdb37ca6d?auto=format&fit=crop&w=800&q=80',
    blurb: 'Microfiber cloths, brush, spray — safe for oleophobic glass.',
  },
  {
    id: 33,
    uuid: 'acc-0033',
    name: 'Bluetooth Item Finder (2-pack)',
    brand: 'Universal',
    deviceLineId: 'all-phones',
    versionId: 'all',
    category: 'Tracker',
    price: 52,
    image: 'https://images.unsplash.com/photo-1620787173607-d7e4f552c1f8?auto=format&fit=crop&w=800&q=80',
    blurb: 'Replaceable battery; loud ring; works with Find apps.',
  },
  {
    id: 34,
    uuid: 'acc-0034',
    name: 'Gaming Controller Clip Mount',
    brand: 'Universal',
    deviceLineId: 'all-phones',
    versionId: 'all',
    category: 'Gaming',
    ...
    blurb: 'Fits major pads; adjustable tilt for cloud gaming.',
  },
  {
    id: 35,
    uuid: 'acc-0035',
    name: 'RFID Blocking Card Sleeve (3-pack)',
    brand: 'Universal',
    deviceLineId: 'all-phones',
    versionId: 'all',
    category: 'Wallet',
    ...
    blurb: 'Slim sleeves for wallet cases; tap-to-pay safe.',
  },
]
